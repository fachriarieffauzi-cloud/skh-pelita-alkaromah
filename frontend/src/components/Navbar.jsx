...
export default function Navbar({ settings }) {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-md border-b border-stone-200" data-testid="navbar">
      <div className="hidden md:flex items-center justify-end gap-3 bg-amber-300 bg-gradient-to-r from-orange-600 via-orange-500/60 to-transparent text-white text-xs px-4 py-1.5">
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 py-3">
        ...
        <div className="hidden lg:flex items-center gap-2">
          <Button
            ...
            className="bg-amber-300 bg-gradient-to-r from-orange-600 via-orange-500/60 to-transparent hover:brightness-105 text-white rounded-full px-5 h-11 font-semibold shadow-lg shadow-orange-200"
